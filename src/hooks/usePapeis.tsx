import {
  removerPapeis as deleteRequest,
  lerPapeis as getRequest,
  atualizarPapeis as patchRequest,
  criarPapeis as postRequest,
} from '@/client/sdk.gen'
import type {
  PatchPapeis as PatchType,
  PostPapeis as PostType,
  LerPapeisData as QueryParams,
  LerPapeisResponse as ResponseType,
